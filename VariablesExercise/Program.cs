namespace VariablesExercise
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Please enter your name for security verification.");
            string employeeName = Console.ReadLine();

            Console.WriteLine($"{employeeName}, Welcome!");
            ...
            Console.WriteLine($"I hope your new career here at {newPark} is a mutually beneficial. Also I hope your accomidations are to your liking, we spared no expense.");
